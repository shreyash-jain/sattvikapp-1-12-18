...
public class ActivityAbout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandAndCollapseText(title_vision,text_vision);
        ...
        expandAndCollapseText(title_history,text_history);
        ...
        expandAndCollapseText(title_registration,text_registration);
        ...
        expandAndCollapseText(title_general,text_general);

    }
    void expandAndCollapseText(final TextView title,final TextView text){
