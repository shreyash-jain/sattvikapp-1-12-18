...
public class ActivityAbout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title_history = (TextView) findViewById(R.id.text_history_title);
        ...
        TextView title_registration = (TextView) findViewById(R.id.text_registration_procedure_title);
        ...
        TextView title_general = (TextView) findViewById(R.id.text_general_rules_title);
